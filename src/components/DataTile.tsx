...
export default function DataTile({ label, value, unit, color = 'text-white' }: DataTileProps) {
  return (
    <div className="flex-1 p-4 bg-zinc-900/20 border border-white/10 rounded-2xl backdrop-blur-md text-center">
      <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-1">{label}</p>
      <div className={`text-xl font-black ${color} whitespace-nowrap`}>{value}</div>
